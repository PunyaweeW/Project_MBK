...
export class AddItemComponent implements OnInit {
  ...
  onSubmit(form) {
    ...
    //reviewing section+++++++++++++++++++++++++++++++++++++++++++++
    formResult.innerHTML = ("ต้องการเพิ่มอะไหล่ใหม่ในหมวด" + groupName.name + " คือ " + this.name + " ยี่ห้อ " + this.brand + " รุ่น " +
      this.version + " " + this.specs + " มีราคาซื้อ " + this.submittedForm.purchase + " บาท " + "ราคาขาย " + this.submittedForm.price + " บาท " + " เป็นจำนวน " + this.submittedForm.numberOf + " หน่วย" + " กำหนดยอดขั้นต่ำ " + this.submittedForm.threshold + " รหัสสินค้า " + this.barcode);
    reviewBox.style.display = "block";
    //end of reviewing section-------------------------------------
  }
  //accep handling section+++++++++++++++++++++
